...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// (スキンメッシュ対応)陰影をつけるオブジェクトの描画の直前処理（不透明な物体やキャラクタの板ポリゴン）
// ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== =====
// シェーダーのパイプライン変更
// LitShaderで使用するリソースのバッファー設定
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdHD2DShader::BeginLit_SkinMesh()
{
	// 頂点シェーダーのパイプライン変更
	if (KdShaderManager::Instance().SetVertexShader(m_VS_Skin))
	{
		KdShaderManager::Instance().SetInputLayout(m_inputLayout_Skin);
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// (スキンメッシュ対応)陰影ありオブジェクトの描画修了
// ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== =====
// 影を書き込む用に使用していたGenDepthFromLightで生成した深度SRVの解放
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdHD2DShader::EndLit_SkinMesh()
{
	ID3D11ShaderResourceView* pNullSRV = nullptr;
	KdDirect3D::Instance().WorkDevContext()->PSSetShaderResources(10, 1, &pNullSRV);
}
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
//  (スキンメッシュ対応)影を生み出すオブジェクトの情報描画（光を遮る物体）
// ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== =====
// シェーダーのパイプライン変更
// GenDepthMapFromLightShaderで使用するリソースのバッファー設定
// 書き込むテクスチャーを深度用の赤一色のテクスチャに切り替え
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdHD2DShader::BeginGenerateDepthMapFromLight_SkinMesh()
{
	if (KdShaderManager::Instance().SetVertexShader(m_VS_GenDepthFromLight_Skin))
	{
		KdShaderManager::Instance().SetInputLayout(m_inputLayout_Skin);
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// (スキンメッシュ対応)影を生み出すオブジェクトの描画終了
// ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== =====
// レンダーターゲットを元に戻す
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdHD2DShader::EndGenerateDepthMapFromLight_SkinMesh()
{
	m_depthMapFromLightRTChanger.UndoRenderTarget();
}
	...
	const Math::Color& colRate, const Math::Vector3& emissive)
{
	...
	if (data->IsSkinMesh())
	{
		...
		{
			if (nodeIdx >= KdHD2DShader::maxBoneBufferSize) { assert(0 && "転送できるボーンの上限数を超えました"); return; }
...
#include "KdHD2DShader_VS_Lit.shaderInc"
	...
	//-------------------------------------
	// 頂点シェーダ(Skin Mesh)スキンメッシュ対応
	//-------------------------------------
	{
		// コンパイル済みのシェーダーヘッダーファイルをインクルード
#include "KdHD2DShader_VS_Skin.shaderInc"
...
#include "KdHD2DShader_VS_GenDepthMapFromLight.shaderInc"
	...
	//-------------------------------------
	{
#include "KdHD2DShader_VS_GenDepthMapFromLight_Skin.shaderInc"

		// 頂点シェーダー作成
		if (FAILED(KdDirect3D::Instance().WorkDev()->CreateVertexShader(compiledBuffer, sizeof(compiledBuffer), nullptr, &m_VS_GenDepthFromLight_Skin))) {
			assert(0 && "頂点シェーダー作成失敗");
			Release();
			return false;
		}
...
void KdHD2DShader::Release()
{
	...
	KdSafeRelease(m_VS_GenDepthFromLight_Skin);
